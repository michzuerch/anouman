...
public class DashboardView extends PolymerTemplate<TemplateModel> {
    ...
    public DashboardView(OrderService orderService, OrdersGridDataProvider orderDataProvider) {
        ...
        grid.addColumn(OrderCard.getTemplate().withProperty("orderCard", OrderCard::create)
                .withProperty("header", order -> null).withEventHandler("cardClick",
    ...
    // This method is overridden to measure the page load performance and can be
    // safely removed
    ...
    private void populateOrdersCounts(DeliveryStats deliveryStats) {
        ...
        OrdersCountDataWithChart todaysOrdersCountData = DashboardUtils.getTodaysOrdersCountData(deliveryStats,
                orders.iterator());
