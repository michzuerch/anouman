...
import com.gmail.michzuerch.anouman.presentation.ui.backup.xml.buchhaltungen.*;
...
public class BackupView extends VerticalLayout implements View {
    ...
    private Panel createPanelBackup() {
        ComboBox<Buchhaltung> listBuchhaltungen = new ComboBox<>();
        ...
        ComboBox<TemplateBuchhaltung> listTemplateBuchhaltungen = new ComboBox<>();
        ...
        ComboBox<Adresse> listAdressen = new ComboBox<>();
    ...
    private Panel createPanelRestore() {
    ...
    private Component createContent() {
        ...
        layout.addComponents(createPanelBackup(), createPanelRestore());
        layout.setSizeFull();
        return layout;
    }
