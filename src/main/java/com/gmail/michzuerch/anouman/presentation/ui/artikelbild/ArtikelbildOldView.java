...
@CDIView("ArtikelbildOldView")
public class ArtikelbildOldView extends VerticalLayout implements View {
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(ArtikelbildOldView.class.getName());
