package com.gmail.michzuerch.anouman.backend.jpa.domain.report.jasper;
...
public class ReportJasper extends AbstractEntity {
    ...
    public List<com.gmail.michzuerch.anouman.backend.jpa.domain.report.jasper.ReportJasperImage> getReportJasperImages() {
        return reportJasperImages;
    }

    public void setReportJasperImages(List<com.gmail.michzuerch.anouman.backend.jpa.domain.report.jasper.ReportJasperImage> reportJasperImages) {
