...
import com.gmail.michzuerch.anouman.backend.session.deltaspike.jpa.repository.AdresseDeltaspikeRepository;
...
@Stateless
public class AdresseDeltaspikeFacade {
    @Inject
    AdresseDeltaspikeRepository repo;
