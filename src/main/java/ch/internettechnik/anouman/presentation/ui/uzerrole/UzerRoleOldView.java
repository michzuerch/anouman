...
@CDIView("UzerRoleOldView")
public class UzerRoleOldView extends VerticalLayout implements View {
    private static final Logger LOGGER = Logger.getLogger(UzerRoleOldView.class.getName());
