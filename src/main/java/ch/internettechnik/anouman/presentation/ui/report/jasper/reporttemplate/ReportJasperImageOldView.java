...
@CDIView("ReportJasperImageOldView")
public class ReportJasperImageOldView extends VerticalLayout implements View {
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(ReportJasperImageOldView.class.getName());
