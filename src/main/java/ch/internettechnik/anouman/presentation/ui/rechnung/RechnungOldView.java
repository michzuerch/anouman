...
@CDIView("RechnungOldView")
public class RechnungOldView extends VerticalLayout implements View {
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(RechnungOldView.class.getName());
    ...
    public void enter(ViewChangeListener.ViewChangeEvent viewChangeEvent) {
        ...
        grid.addColumn(rechnung -> rechnung.getAdresse().getFirma() + " " +
                ...
                new ButtonRenderer(event -> {
                    ...
                    UI.getCurrent().getNavigator().navigateTo("AdresseOldView/id/" + rechnung.getAdresse().getId());
                })
