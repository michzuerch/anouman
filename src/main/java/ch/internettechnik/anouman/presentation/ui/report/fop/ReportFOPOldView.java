...
@CDIView("ReportFOPOldView")
public class ReportFOPOldView extends VerticalLayout implements View {
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(ReportFOPOldView.class.getName());
