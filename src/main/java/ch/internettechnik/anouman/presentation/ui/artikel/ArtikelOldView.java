...
@CDIView("ArtikelOldView")
public class ArtikelOldView extends VerticalLayout implements View {
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(ArtikelOldView.class.getName());
