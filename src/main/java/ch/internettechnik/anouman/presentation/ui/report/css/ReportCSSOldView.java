...
@CDIView("ReportCSSOldView")
public class ReportCSSOldView extends VerticalLayout implements View {
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(ReportCSSOldView.class.getName());
