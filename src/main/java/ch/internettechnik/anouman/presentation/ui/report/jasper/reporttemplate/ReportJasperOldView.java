...
@CDIView("ReportJasperOldView")
public class ReportJasperOldView extends VerticalLayout implements View {
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(ReportJasperOldView.class.getName());
