...
import ch.internettechnik.anouman.backend.session.deltaspike.jpa.repository.TemplateKontohauptgruppeRepository;
...
@Stateless
public class TemplateKontohauptgruppeFacade {
    @Inject
    TemplateKontohauptgruppeRepository repo;
