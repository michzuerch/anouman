...
import ch.internettechnik.anouman.backend.session.deltaspike.jpa.repository.RechnungspositionRepository;
...
@Stateless
public class RechnungspositionFacade {
    @Inject
    RechnungspositionRepository repo;
