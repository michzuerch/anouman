...
import ch.internettechnik.anouman.backend.session.deltaspike.jpa.repository.MehrwertsteuercodeRepository;
...
@Stateless
public class MehrwertsteuercodeFacade {
    @Inject
    MehrwertsteuercodeRepository repo;
